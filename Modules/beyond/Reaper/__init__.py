...
if RunningInside:
  ...
  def SendOSC_Action(Address, ActionID):
    ...
    message = b'/action\0,s\0\0_RS4f2f870dd222ceb7bbc3c77f7f5dd2ac4a09074c\0'
    S.sendto(struct.pack(">57s", message), Address)
    #',s'struct.pack(">12si", b"/action\0,i\0\0", ActionID)
    S.close()
